...
/**
 * API for external clients and {@link ControlDelegate}s for getting key property values of the render context and
 * its current control state.
 *
 * @author Randy Picolet
 */
public interface RenderStatus extends ControlComponent {

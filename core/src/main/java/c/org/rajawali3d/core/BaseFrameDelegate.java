...
public abstract class BaseFrameDelegate extends BaseComponent implements FrameDelegate {
     ...
     * {@link FrameDelegate} has been added to the {@link RenderControl}.
     * <p>
    ...
    /**
     * Releases graphic-system resources; invoked when this FrameDelegate has been removed
    ...
    */
    ...
    private class AddAnimationsTask extends RenderTask {
        ...
        @Override
        protected void doTask() {
            BaseFrameDelegate.this.animations.addAll(animations);
        }
    }
    */

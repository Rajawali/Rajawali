 ...
 * <p>
 * An object's {@link IndexedGeometry} and its data can be accessed by calling the getGeometry() and its methods:
 * <pre><code> // Get the geometry instance
 * IndexedGeometry geom = mMyObject.getGeometry();
 * // Get vertices (x, y, z)
...
public class IndexedGeometry implements Geometry {
    ...
    /**
     * Copies another {@link IndexedGeometry}'s BufferInfo objects. This means that it doesn't copy or clone the actual data.
     * It will just use the pointers to the other {@link IndexedGeometry}'s buffers.
     *
     * @param geom
     *
     * @see BufferInfo
    ...
    /**
     * Sets the data. This methods takes two {@link BufferInfo} objects which means it will use another {@link IndexedGeometry}

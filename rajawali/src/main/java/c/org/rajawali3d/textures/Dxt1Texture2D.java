...
public class Dxt1Texture2D extends CompressedTexture2D {
    ...
    public Dxt1Texture2D(Dxt1Texture2D other) throws TextureException {
        super(other);
        setDxt1Format(other.getDxt1Format());
    }

    public Dxt1Texture2D(String textureName, ByteBuffer byteBuffer, Dxt1Format dxt1Format) throws TextureException {
     ...
     *
     * @param other another Dxt1Texture object to copy from
     */
    public void setFrom(Dxt1Texture2D other) throws TextureException {
        super.setFrom(other);
        mDxt1Format = other.getDxt1Format();
    }

    @Override
    public Dxt1Texture2D clone() {
        try {
            return new Dxt1Texture2D(this);
    ...
    /**
     * @param dxt1Format the DXT1 Texture2D Compression format. See {@link Dxt1Format}.
     */
    public void setDxt1Format(Dxt1Format dxt1Format) {
        this.mDxt1Format = dxt1Format;
        switch (dxt1Format) {
            case RGB:
                setTexelFormat(GL_COMPRESSED_RGB_S3TC_DXT1_EXT);
                break;
            case RGBA:
            default:
                setTexelFormat(GL_COMPRESSED_RGBA_S3TC_DXT1_EXT);
                break;
        }
    }
}

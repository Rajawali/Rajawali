...
public interface IRajawaliDisplay {
    ...
    /**
     * Creates the {@link RajawaliRenderer} to use in this display. Optionally null can be returned by displays
     ...
     *
     * @return {@link RajawaliRenderer} The renderer which will be assigned to the {@link GLSurfaceView} in this display, or null.
     */

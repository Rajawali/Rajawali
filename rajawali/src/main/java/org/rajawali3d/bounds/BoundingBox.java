...
public class BoundingBox implements IBoundingVolume {
    ...
    protected final Vector3 mPosition, mTransformedPosition;
    ...
    public void transform(final Matrix4 matrix) {
        ...
        mTransformedPosition.setAll(mPosition).multiply(matrix);
    }
    ...
    public Vector3 getPosition() {
        mTransformedPosition.setAll((mTransformedMax.x + mTransformedMin.x) / 2.0,
                                    (mTransformedMax.y + mTransformedMin.y) / 2.0,
                                    (mTransformedMax.z + mTransformedMin.z) / 2.0);

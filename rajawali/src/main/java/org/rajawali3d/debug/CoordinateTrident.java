...
public class CoordinateTrident extends Object3D {
    ...
    public CoordinateTrident() {
        ...
        // Axis Arms
        final Cylinder xAxis = new Cylinder(1f, 0.05f, 1, 6);
        ...
        xTip.setPosition(1.125f, 0, 0);
        addChild(xTip);

        final Cylinder yAxis = new Cylinder(1f, 0.05f, 1, 6);
        ...
        yTip.setPosition(0, 1.125f, 0);
        addChild(yTip);

        final Cylinder zAxis = new Cylinder(1f, 0.05f, 1, 6);

    ...
    public void parseBlock(AWDLittleEndianDataInputStream dis, BlockHeader blockHeader) throws Exception {
        ...
        switch (mMaterialType) {
            ...
            case TYPE_TEXTURE:
                ...
                if (diffuseTexture > 0) {
                    final Bitmap bitmap = lookup(blockHeader, diffuseTexture);
                ...
                if (ambientTexture > 0) {
                    final Bitmap bitmap = lookup(blockHeader, ambientTexture);
        ...
        if (specularTexture > 0) {
            final Bitmap bitmap = lookup(blockHeader, specularTexture);
        ...
        if (normalTexture > 0) {
            final Bitmap bitmap = lookup(blockHeader, normalTexture);

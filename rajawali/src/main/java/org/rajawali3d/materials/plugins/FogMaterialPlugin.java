...
public class FogMaterialPlugin implements IMaterialPlugin {
	...
	private final class FogVertexShaderFragment extends Shader implements IShaderFragment {
	...
	private final class FogFragmentShaderFragment extends Shader implements IShaderFragment {

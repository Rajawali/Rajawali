...
import c.org.rajawali3d.materials.shaders.DataType;
...
public abstract class ShaderBase {
    ...
    public interface GlobalShaderVar {
        ...
        @NonNull String getVarString();

        @NonNull String getDataType();
    }
     ...
     * The {@link Shader} class uses ShaderVars to write a text file under the hood.

...
public class BumpmapAlphaMaterial extends BumpmapMaterial {
	...
	public BumpmapAlphaMaterial() {
		this(false);
	}
	
	public BumpmapAlphaMaterial(String vertexShader, String fragmentShader, boolean isAnimated) {
		super(vertexShader, fragmentShader, isAnimated);
	}
	
	public BumpmapAlphaMaterial(boolean isAnimated) {

...
public class PhongAlphaMaterial extends PhongMaterial {
...
//	    "	gl_FragColor = Lc * diffuse + ambient + specular;\n" + 
	...
	public PhongAlphaMaterial() {
		this(false);
	}
	
	public PhongAlphaMaterial(boolean isAnimated) {
...
//			fc.append("Lc.rgb = uLightColor").append(i).append(";\n");
